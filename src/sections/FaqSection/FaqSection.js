const FaqSection = () => {
  return (
    <div id="faq" className="mainDiv">
        <div className="tittle flex justify-center font-bold"><h2 className="text-3xl my-8">Here Is The FAQ</h2></div>
      <div className="w-full md:w-4/6 mx-auto my-10">
        ...
        >
          ...
          <div className="collapse-content">
            <p>Depending on your flavor of business and the products you sell, your FAQs will of course be different. It’s up to you to determine what the critical questions being asked by your unique customers are. Whatever content you populate your FAQ with, make sure the language and style is congruent with your brand personality. Who said FAQs had to be boring?</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="collapse-content">
            <p>You probably have this detailed in a special location somewhere else on your website. But this is likely the most frequently asked question in any retail situation, online or brick-and-mortar — so onto the FAQ page it goes. You should include a sentence or two about your policy, and conclude with, “Click here to learn more about our full return and exchange policy.</p>
          </div>
        </div>
